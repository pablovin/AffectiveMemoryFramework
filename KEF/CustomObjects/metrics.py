...
def ccc(y_true, y_pred):
    ...
    #
    #     cov = K.mean(K.prod((y_pred - pred_mean),(y_true - true_mean)))
    #
    #     ccc_value_denominator = K.square(pred_std) +  K.square(true_std) + K.square(pred_mean - true_mean)
    #                                       #numpy.square(numpy.subtract(pred_mean, true_mean)))
    #
    #     return ( 2 * cov) / ccc_value_denominator
